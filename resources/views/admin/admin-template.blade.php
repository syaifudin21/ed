...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
  <header class="app-header" style="background-color: {{env('COLOR_ADMIN', '#fff')}}">
    ...
    <aside class="app-sidebar" style="background-color: {{env('THEME_COLOR')}}">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{(Request::is('admin/guru') OR \Request::is('admin/guru/*'))? 'active': ''}}" href="{{route('admin.guru')}}"><i class="app-menu__icon fa fa-tasks"></i><span class="app-menu__label">Guru</span></a></li>
        
        <li><a class="app-menu__item {{(Request::is('admin/siswa') OR \Request::is('admin/siswa/*'))? 'active': ''}}" href="{{route('admin.siswa')}}"><i class="app-menu__icon fa fa-tasks"></i><span class="app-menu__label">Siswa</span></a></li>
        <li><a class="app-menu__item {{(Request::is('admin/skema') OR \Request::is('admin/skema/*'))? 'active': ''}}" href="{{route('admin.skema')}}"><i class="app-menu__icon fa fa-tasks"></i><span class="app-menu__label">Skema</span></a></li>
